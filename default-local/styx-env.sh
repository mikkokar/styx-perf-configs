...
#   517  docker exec -it e88b97226728 sh -c "jcmd 1 JFR.dump filename=/styx/logs/perf-02.jfr"
...
JAVA_OPTS="$JAVA_OPTS -Xlog:gc*=debug:file=/styx/logs/gc.log"
JAVA_OPTS="$JAVA_OPTS -DSLIDING_WINDOW_HISTOGRAM_INTERVALS=1 -DINTERVAL_DURATION=6000"
